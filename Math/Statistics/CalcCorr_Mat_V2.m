function [ MatCorr ] = CalcCorr_Mat_V2( MatIn, Dims, MaxTimeLag, parFlag )
...
% Divide by the variance of each pixel
VarDiag = sqrt(diag(MatCorr(:, :, 1)));
MatCorr = MatCorr./repmat(VarDiag*VarDiag', 1, 1, MaxTimeLag);
