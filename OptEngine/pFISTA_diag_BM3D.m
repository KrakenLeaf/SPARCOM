function [ x ] = pFISTA_diag_BM3D( Y, H, Params )
% PFISTA_DIAG_BM3D - Performs the Fast Proximal Gradient method on the problem
% 
...
for kk = 1:Params.IterMax
    ...
    x_prev = x;
    [~, x] = BM3D(1, reshape(g, sqrt(N), sqrt(N)));
    x = vec(x);  
